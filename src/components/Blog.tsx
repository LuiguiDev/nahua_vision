...
const Blog: React.FC<BlogProps> = ({blog, goToBlog}) => {
  if (!blog) return
    ...
    <article className="blog_article">
      ...
      <div className="blog_content">
        <div className="blog_title">
          <img src="./src/images/news/diciembre lluvia de estrellas.jpg" />
        ...
        <main>
          ...
          <section>
            ...
            <blockquote>
              ...
              <footer>- Fray Bernardino de Sahagún</footer>
            </blockquote>

            <div className="image_container">
              <img src="./src/images/explore_images/Citlalin tlamina labeled.png" width={'100%'}/>
